...
# emergency login
@app.route("/auth/emergency")
def emer_auth():
    session["username"] = "c1615528"
    check_permission("c1640644")
    return "logged in"
    ...
    if 'username' in session:
        ...
        try:
            with connection.cursor() as cursor:
                ...
                sql1 = "INSERT INTO General (Title, PRE_ID, Student_Name, Student_Num, Supervisor_Name, Principle_Researcher, Other_Researchers, Project_start, Project_end, Full_Project_Plan, FPP_ID, Participant_Info_Form, PIF_ID, Consent_Form, CF_ID, RIOTP, RIOTP_ID, External_Funding, EF_ID, Motivations, M_ID) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
                
                sql2 = "INSERT INTO Info (N_1, N_1_1, N_2, N_3, N_4, N_5, N_6, N_7, E_1, E_1_1, N_8, N_9, N_10, N_11, N_12, E_2, N_13, N_14, E_3, E_3_3, N_15, N_16, N_16_16, N_17, N_17_17, E_4, E_4_4, N_18, E_5, N_19, N_20, E_6, N_21, E_7, E_8, E_9) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"

                cursor.execute(sql1, (request.form["Title"], request.form["PRE_ID"], request.form["Student_Name"], request.form["Student_Num"], request.form["Supervisor_Name"], request.form["Principle_Researcher"], request.form["Other_Researchers"], request.form["Project_start"], request.form["Project_end"], request.form["Full_Project_Plan"], request.form["FPP_ID"], request.form["Participant_Info_Form"], request.form["PIF_ID"], request.form["Consent_Form"], request.form["CF_ID"], request.form["RIOTP"], request.form["RIOTP_ID"], request.form["External_Funding"], request.form["EF_ID"], request.form["Motivations"], request.form["M_ID"]))
                
                cursor.execute(sql2, (request.form["N_1"], request.form["N_1_1"], request.form["N_2"], request.form["N_3"], request.form["N_4"], request.form["N_5"], request.form["N_6"], request.form["N_7"], request.form["E_1"], request.form["E_1_1"], request.form["N_8"], request.form["N_9"], request.form["N_10"], request.form["N_11"], request.form["N_12"], request.form["E_2"], request.form["N_13"], request.form["N_14"], request.form["E_3"], request.form["E_3_3"], request.form["N_15"], request.form["N_16"], request.form["N_16_16"], request.form["N_17"], request.form["N_17_17"], request.form["E_4"], request.form["E_4_4"], request.form["N_18"], request.form["E_5"], request.form["N_19"], request.form["N_20"], request.form["E_6"], request.form["N_21"], request.form["E_7"], request.form["E_8"], request.form["E_9"]))                
